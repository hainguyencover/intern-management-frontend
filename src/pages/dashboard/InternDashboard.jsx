...
const FileText = ({ ...props }) => <FileTextOutlined {...props} />;
const Inbox = (props) => <Clock {...props} />;
// Map missing antd icons to lucide if needed, but I already used lucide icons above.
// Re-importing to ensure no missing icons
