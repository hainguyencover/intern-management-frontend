...
export const hrListGroups = (programId) =>
    axiosClient.get(`/api/v1/hr/programs/${programId}/groups`).then((r) => r.data);

export const hrAssignMember = (groupId, internId) =>
    axiosClient.post(`/api/v1/hr/groups/${groupId}/members`, { internId }).then((r) => r.data);

export const hrListGroupMembers = (groupId) =>
    axiosClient.get(`/api/v1/hr/groups/${groupId}/members`).then((r) => r.data);

export const hrRemoveMember = (groupId, internId) =>
    axiosClient.delete(`/api/v1/hr/groups/${groupId}/members/${internId}`).then((r) => r.data);
